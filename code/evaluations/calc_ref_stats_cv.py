...
if __name__ == '__main__':
    ...
    LABEL_LIST_PATH = f'./datasets/split_{args.split}_image_list_{args.dataset}_{args.augmentation}.txt'
    train_filenames_and_labels = np.loadtxt(LABEL_LIST_PATH, dtype=np.str)

    get_samples = get_imagenet_samples

    stat_dir = f'./datasets/split_{args.split}_{args.dataset}_{args.augmentation}_stats'
